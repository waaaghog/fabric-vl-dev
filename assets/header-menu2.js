...
class HeaderMenu extends Component {
  ...
  deactivate(event) {
    ...
    const isPointerMovingToSubmenu =
      event.type === 'pointerleave' && event.relatedTarget instanceof Node && menu?.contains(event.relatedTarget);

    if (isMovingWithinMenu || isMovingToOverflowMenu || isMovingToSubmenu || isPointerMovingToSubmenu) {
      return;
    }
